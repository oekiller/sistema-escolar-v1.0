...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-list" aria-hidden="true"></i> Lista de Alumnos</h1>
            ...
            <div class="tile">
                <div class="tile-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered" id="table_alumnosE">
                            <thead>
                                <tr>
                                    <th>ALUMNO</th>
                                    <th>CEDULA</th>
                                    <th>ULTIMO INGRESO AL SISTEMA</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if ($row > 0) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if ($res_acceso['u_acceso'] == null) {
                                                    echo '<kbd class="badge badge-danger">NO HASTA EL MOMENTO</kbd>';
                                                } else {
                                                    //echo $res_acceso['u_acceso']. '<kbd class="badge badge-success">NO HASTA EL MOMENTO</kbd>';
