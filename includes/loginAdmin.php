            ...
            if (password_verify($pass, $result['clave'])) {
                ...
                if ($result['estado'] == 1) {
                    if ($result['estado'] == 1) {
                        ...
                        echo '<div class="alert alert-warning" style="text-align: center;"><button type="button" class="close" data-dismiss="alert">&times;</
                        button>Usuario Inactivo</div>';
                    }
                } else {
                    echo '<div class="alert alert-warning" style="text-align: center;"><button type="button" class="close" data-dismiss="alert">&times;</
                    button>Usuario Inactivo</div>';
                ...
                echo '<div class="alert alert-danger" style="text-align: center;"><button type="button" class="close" data-dismiss="alert">&times;</button>Usuario o 
